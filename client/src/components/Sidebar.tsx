...
export default function Sidebar({ isOpen, onClose, onSectionClick, onPageClick }: SidebarProps) {
  ...
  const menuItems = [
    ...
    { id: "training", label: t("training"), icon: BookOpen, type: "section" },
    { id: "video-showcase", label: "Training Videos", icon: PlayCircle, type: "section" },
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className={`fixed left-0 top-16 h-full w-64 bg-slate-900 transform transition-transform duration-300 z-50 overflow-y-auto ${
